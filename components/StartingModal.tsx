...
const StartingModal: React.FC<StartingModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-[1000] p-4" style={{ maxWidth: '100vw', maxHeight: '100vh' }}>
      ...
      {/* Floating modal with glassmorphism */}
      <div 
        className="relative bg-white/70 backdrop-blur-xl p-3 sm:p-4 lg:p-6 rounded-3xl shadow-2xl w-80 sm:w-[30rem] lg:w-[28rem] max-w-[90vw] mx-auto overflow-y-auto border border-white/50" 
        style={{ 
      ...
      >
        <h2 className="font-bold text-lg sm:text-xl lg:text-2xl text-center mb-2 sm:mb-3 lg:mb-4 bg-gradient-to-r from-gray-700 to-gray-900 bg-clip-text text-transparent">
          Do You Know what is Around You?
        </h2>
        <h1 className="font-bold text-xl sm:text-2xl lg:text-4xl text-center bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent mb-3 sm:mb-4 lg:mb-6" style={{ 
        ...
        <div className="mt-2 flex flex-col gap-2 sm:gap-3">
          <button 
            onClick={onButton1} 
            className="px-3 py-2 sm:px-4 sm:py-2.5 lg:py-3 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700 transition-all text-sm sm:text-base flex items-center justify-start gap-2 sm:gap-3 shadow-lg hover:shadow-xl hover:scale-105 duration-300"
          ...
          <button 
            onClick={onButton2} 
            className="px-3 py-2 sm:px-4 sm:py-2.5 lg:py-3 rounded-xl bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white hover:from-blue-600 hover:via-purple-600 hover:to-pink-600 transition-all text-sm sm:text-base flex items-center justify-start gap-2 sm:gap-3 shadow-lg hover:shadow-xl hover:scale-105 duration-300"
            style={{ 
          ...
          <button 
            onClick={onButton3} 
            className="px-3 py-2 sm:px-4 sm:py-2.5 lg:py-3 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:from-purple-600 hover:to-pink-600 transition-all text-sm sm:text-base flex items-center justify-start gap-2 sm:gap-3 shadow-lg hover:shadow-xl hover:scale-105 duration-300"
            style={{ backdropFilter: 'blur(8px)' }}
          >
          ...
          <div className="mt-2 sm:mt-3 lg:mt-4 pt-2 sm:pt-3 lg:pt-4 border-t border-gray-200">
            ...
            <div className="flex items-center gap-3 sm:gap-4 mt-3 sm:mt-2" style={{ minHeight: '40px' }}>
              ...
              {/* Favorites buttons - aligned with slider edges */}
              <div className="flex items-center justify-between flex-1 gap-2">
                <button
                  type="button"
                  className="px-3 py-2 text-xs bg-gradient-to-r from-blue-400 to-blue-500 text-white rounded-lg shadow-md hover:from-blue-500 hover:to-blue-600 hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer whitespace-nowrap font-medium"
                ...
                {onResetAttractions && (
                  <button
                    type="button"
                    className="px-3 py-2 text-xs bg-gradient-to-r from-red-400 to-red-500 text-white rounded-lg shadow-md hover:from-red-500 hover:to-red-600 hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer whitespace-nowrap font-medium"
