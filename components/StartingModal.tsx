  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-[1000] p-4" style={{ maxWidth: '100vw', maxHeight: '100vh' }}>
      <div className="bg-white/90 backdrop-blur-sm p-3 sm:p-4 rounded-lg shadow-xl w-80 max-w-xs mx-auto" style={{ maxWidth: 'calc(100vw - 2rem)', maxHeight: 'calc(100vh - 2rem)' }}>
        ...
        <h1 className="font-bold text-2xl sm:text-4xl text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4 sm:mb-6">Find Places</h1>
        <div className="mt-2 flex flex-col gap-2 sm:gap-3">
          <button onClick={onButton1} className="px-3 py-2 sm:px-4 sm:py-3 rounded bg-blue-600 text-white hover:bg-blue-700 transition-colors text-sm sm:text-base flex items-center justify-start gap-3">
            <svg className="w-7 h-7 sm:w-10 sm:h-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <mask id="pinMask1">
          ...
          <button onClick={onButton2} className="px-3 py-2 sm:px-4 sm:py-3 rounded bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:from-blue-700 hover:to-purple-700 transition-all text-sm sm:text-base flex items-center justify-start gap-3">
            <svg className="w-7 h-7 sm:w-10 sm:h-10" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <mask id="pinMask2">
                  <rect width="200" height="200" fill="white"/>
          ...
          <button onClick={onButton3} className="px-3 py-2 sm:px-4 sm:py-3 rounded bg-purple-600 text-white hover:bg-purple-700 transition-colors text-sm sm:text-base flex items-center justify-start gap-3">
          ...
          <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-200">
            ...
            <div className="flex items-center justify-center gap-2 mt-3 pt-2 border-t border-gray-200">
              ...
              <label htmlFor="location-tracking-checkbox" className="text-xs font-medium text-gray-700 flex items-center gap-1">
                ...
                {isRequestingLocation && (
                  <span className="text-orange-600 ml-1" title="Requesting location permission">📍</span>
                )}
              </label>
            </div>
